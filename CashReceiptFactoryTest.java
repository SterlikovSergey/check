...
public class CashReceiptFactoryTest {
    ...
    // Create a check with valid receipt items and a discount card
    @Test
    public void test_create_check_with_valid_receipt_items_and_discount_card() {
        // Arrange
        Product product1 = new Product(1L, "Product 1", BigDecimal.valueOf(10.00), false);
        Product product2 = new Product(2L, "Product 2", BigDecimal.valueOf(20.00), true);
